...
export default function Faqs() {
  const options = [
    ...
    { id: 5, answer: "Cuando lo desees te podemos ayudar con el armado del Estilismo,\nla puesta en escena, manejo de los equipos de iluminación,\ncontratación de fotógrafos, maquilladores,\nfilmakers y cualquier otro requerimiento que tengas",},
    { id: 6, answer: "Nuestro horario es 24 horas." },
    { id: 7, answer: "¡Claro!!!!\nPuedes ingresar a nuestras instalaciones con 15 min de anticipación.\nAl set si puedes ingresar sólo en el horario reservado.\nAsí que te esperamos y nos tomamos un café.",},
